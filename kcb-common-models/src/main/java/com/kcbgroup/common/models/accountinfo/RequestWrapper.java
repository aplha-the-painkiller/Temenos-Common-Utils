...
public class RequestWrapper implements Serializable {
    ...
    private AccountInfoRequestPayload requestPayload;
	...
	public AccountInfoRequestPayload getRequestPayload() {
		return requestPayload;
	}

	public void setRequestPayload(AccountInfoRequestPayload requestPayload) {
