...
public class AdditionalData implements Serializable {
	...
	/**
	 * @param chargeCustomer the chargeCustomer to set
	 */
	public void setChargeCustomer(String chargeCustomer) {
