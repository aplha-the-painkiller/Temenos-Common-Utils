 ...
 * @author jgnjeru
 */
@XmlRootElement(name = "GetDataByPassportResult", namespace = "http://schemas.datacontract.org/2004/07/IPRSManager")
@XmlAccessorType(XmlAccessType.FIELD)
public class GetDataByPassportResult {
